...
$(function () {
    ...
    if(url.indexOf('profile') >= 0){
        ...
        var postsManageLi = $('.posts-manage');
        ...
        var boardsManageLi = $('.boards-manage');
        boardsManageLi.addClass('unfold').siblings().removeClass('unfold');
    }else if(url.indexOf('fusers') >= 0){
        var fusersManageLi = $('.fusers-manage');
        fusersManageLi.addClass('unfold').siblings().removeClass('unfold');
    }else if(url.indexOf('cusers') >= 0){
        var cusersManageLi = $('.cusers-manage');
        cusersManageLi.addClass('unfold').siblings().removeClass('unfold');
    }else if(url.indexOf('croles') >= 0){
        var crolesManageLi = $('.croles-manage');
        crolesManageLi.addClass('unfold').siblings().removeClass('unfold');
